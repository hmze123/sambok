...
class ProfileRepliesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_profile_replies, container, false)
        val comingSoonTextView = view.findViewById<TextView>(R.id.tvComingSoon)

        // Set the text, using the user ID if it exists.
        comingSoonTextView.text = "Replies feature coming soon!\n🚀"
    ...
    companion object {
         ...
         *
         * @param userId The ID of the user whose replies are to be displayed.
         * @return A new instance of fragment ProfileRepliesFragment.
         */
        @JvmStatic
